...
| 7 | 1 | Implement container-orchestrated solutions | Monitor dan troubleshoot solusi di AKS dan Container Apps: logs, events, konektivitas end-to-end | AKS, Container Apps | d1-03 (bagian Container Apps — Draft) + d1-04 (bagian AKS — menyusul) | Inspeksi logs/events/probes; uji konektivitas | SRC-002, SRC-024, SRC-026, SRC-058, SRC-059 | Specific docs identified | Draft |
